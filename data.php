...
$sql = "SELECT to_char(release_date, 'MM') as month, to_char(release_date, 'Month') as month2, count(*) as nb_of_releases from game_details where to_char(release_date, 'YYYY') = '".$y."' group by month, month2 order by month ";
